          ...
          <>
            ...
            { 
              editId === String(row.id) &&
                <>
                  <TableRow>
                    <TableCell><TextField disabled value={id} /* onChange={handleIdChange} *//></TableCell>
                    <TableCell><TextField disabled value={equipmentId}/></TableCell>
                    <TableCell><TextField select value={status} onChange={handleStatusChange}>
                    ...
                    <TableCell><TextField select value={priority} onChange={handlePriorityChange}>
